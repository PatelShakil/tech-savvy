            ...
            <div className="w-full min-h-screen flex items-center justify-center bg-black">
                <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
                    <div className="w-full text-3xl font-bold">
                        <h1 className="w-full md:w-2/3">How can we help you ?<br />get
                            in touch</h1>
                    </div>
                    <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                        <p className="w-full md:w-2/3 text-gray-400">Tech Savvy transforms ideas into reality with innovative technology and exceptional user experiences. We deliver custom software solutions tailored to your business needs, ensuring seamless and robust applications.</p>
                        <div className="w-44 pt-6 md:pt-0">
                            <Link to={"https://tech-savvy-solution.web.app/contactus"} className="bg-red-500 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">Contact
                                US</Link>
                        </div>
                    </div>
