...
import { Program, Milestone } from '../../../types/program';
    ...
    return (
        <DashboardLayout>
            <div className="max-w-4xl mx-auto">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-gray-800">Add New Program</h1>
                    <p className="text-gray-600 mt-1">Create a new internship or training program</p>
                </div>
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg space-y-3">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className="self-end px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition"
                                >
                                    Add Milestone
                                </button>
                            </div>
