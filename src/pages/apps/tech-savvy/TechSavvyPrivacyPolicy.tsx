...
const TechSavvyPrivacyPolicy = () => {
    return <div className={"my-16 text-justify pb-10 py-3 px-10 bg-white text-black"}>
        ...
        <ul>
            ...
            <li>
                <p><strong>Application</strong> refers to Tech Savvy Solution, the software program provided by the
                    Company.</p>
            </li>
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Tech
                    Savvy Solution.</p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: tech.savvy.it.solution@gmail.com</li>
        </ul>
        <h2>Contact Us</h2>
        <p>If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul>
...
export default TechSavvyPrivacyPolicy